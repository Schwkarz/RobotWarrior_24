...
CAT(ui_, CAT(FRAME_OBJ_NUM, _frame_t)) ui_default_group1_4;
ui_interface_line_t *ui_default_group1_line_1 = (ui_interface_line_t *)&(ui_default_group1_4.data[0]);
ui_interface_line_t *ui_default_group1_line_2 = (ui_interface_line_t *)&(ui_default_group1_4.data[1]);
ui_interface_line_t *ui_default_group1_line_3 = (ui_interface_line_t *)&(ui_default_group1_4.data[2]);
ui_interface_line_t *ui_default_group1_line4 = (ui_interface_line_t *)&(ui_default_group1_4.data[3]);
ui_interface_line_t *ui_default_group1_line5 = (ui_interface_line_t *)&(ui_default_group1_4.data[4]);

void _ui_init_default_group1_4() {
    for (int i = 0; i < OBJ_NUM; i++) {
        ui_default_group1_4.data[i].figure_name[0] = FRAME_ID;
        ui_default_group1_4.data[i].figure_name[1] = GROUP_ID;
        ui_default_group1_4.data[i].figure_name[2] = i + START_ID;
        ui_default_group1_4.data[i].operate_tpyel = 1;
    }
    for (int i = OBJ_NUM; i < FRAME_OBJ_NUM; i++) {
        ui_default_group1_4.data[i].operate_tpyel = 0;
    }
    ...
    ui_default_group1_line_2->end_x = 1021;
    ...
    CAT(ui_proc_, CAT(FRAME_OBJ_NUM, _frame))(&ui_default_group1_4);
    SEND_MESSAGE((uint8_t *) &ui_default_group1_4, sizeof(ui_default_group1_4));
}

void _ui_update_default_group1_4() {
    for (int i = 0; i < OBJ_NUM; i++) {
        ui_default_group1_4.data[i].operate_tpyel = 2;
    }
...
void _ui_remove_default_group1_4() {
    for (int i = 0; i < OBJ_NUM; i++) {
        ui_default_group1_4.data[i].operate_tpyel = 3;
    }
