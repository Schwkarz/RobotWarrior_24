...
void chassis_set_contorl(chassis_move_t *chassis_move_control)
{
    ...
    {
        static fp32 last_relative_angle = 0.0f;
        ...
        if (fabs(chassis_move_control->chassis_yaw_motor->relative_angle) - last_relative_angle < (90 / 180 * PI))
        {
        ...
        last_relative_angle = chassis_move_control->chassis_yaw_motor->relative_angle;
